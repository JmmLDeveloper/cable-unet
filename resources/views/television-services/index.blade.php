<x-page-layout page-title="Admin Panel">
    ...
    <div class="w-full h-screen overflow-y-scroll overflow-x-hidden border-t flex flex-col px-12 py-8">
        <div class="flex items-center">
            <h1 class="text-4xl text-black"> List of television services</h1>
            <a
                href="{{ route('admin.television-service-create-form') }}"
        ...
        <div class="py-8 w-full">
            <x-data-table :column-names="['id','name','tier']" :records="$television_services" />
        </div>
    </div>
