<x-page-layout page-title="Admin Panel">
    ...
    <div class="w-full  h-screen overflow-y-scroll overflow-x-hidden border-t flex flex-col px-12 py-8">
        <div class="flex items-baseline">
            <a href="{{ route('admin.internet-service-list') }}">
                <i class=" rounded-full primary-color shadow-lg hover:shadow-xl  text-4xl fas fa-arrow-circle-left mr-3"></i>
            </a>
            <h1 class="text-4xl text-black"> Create a new internet service</h1>
        </div>
        ...
        <div class="w-full lg:w-1/2 my-6 pr-0 lg:pr-2">
            <div class="leading-loose">
                <form class="p-6 bg-white rounded shadow-xl" action="store" method="POST" >
                    ...
                    <div class="mt-2">
                        <label class="block text-md text-gray-600" for="bandwidth-input">Bandwidth ( in kilobytes )</label>
                        <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="bandwidth-input" name="bandwidth" type="number" required="" placeholder=" Internet Bandwidth ">
                    </div>
                    <div class="mt-6">
